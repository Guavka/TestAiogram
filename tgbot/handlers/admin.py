...
def register_admin(dp: Dispatcher):
    dp.register_message_handler(admin_start, commands=["start"], state="*", is_main_human=True)
    dp.register_message_handler(admin_end, commands=["end"], state="*", is_main_human=True)
